...
import com.example.costall.helper.DatabaseHandler;
import com.example.costall.helper.Functions;
import com.example.costall.helper.SessionManager;
    ...
    private void init() {
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!otp.isEmpty()) {
                    EmailVerify.this.verifyCode(email, otp);
        ...
        btnResend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String email = bundle.getString("email");
                EmailVerify.this.resendCode(email);
            }
        });
     ...
     //   showDialog("Checking in ...");
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        logout.logoutUser(EmailVerify.this.getApplicationContext());
                   ...
                   /* Intent upanel = new Intent(EmailVerify.this, HomeActivity.class);
                    ...
                    startActivity(upanel);*/
                        ...
                        Toast.makeText(EmailVerify.this.getApplicationContext(), "Invalid Verification Code", Toast.LENGTH_LONG).show();
                        textVerifyCode.setError("Invalid Verification Code");
                    }
                } catch (JSONException e) {
                    // JSON error
                    e.printStackTrace();
                    Toast.makeText(EmailVerify.this.getApplicationContext(), "Json error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EmailVerify.this.getApplicationContext(), error.getMessage(), Toast.LENGTH_LONG).show();
                // hideDialog();
            }
        }) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    // Check for error node in json
                    if (!error) {
                        Toast.makeText(EmailVerify.this.getApplicationContext(), "Code successfully sent to your email!", Toast.LENGTH_LONG).show();
                        btnResend.setEnabled(false);
                        EmailVerify.this.countDown();
                    } else {
                        Toast.makeText(EmailVerify.this.getApplicationContext(), "Code sending failed!", Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    // JSON error
                    e.printStackTrace();
